...
create_tile_type_registry :: proc() -> (result: ^Game_Map_Tile_Registry, error: union {
...
populate_tile_type_registry_defaults :: proc(
	...
	register_tile_type(
		registry,
		Game_Map_Tile_Type{id = 1, alias = "terminal_fps:air", name = "Air", solid = false},
	) or_return
	register_tile_type(
		registry,
		Game_Map_Tile_Type{id = 2, alias = "terminal_fps:wall", name = "Wall", solid = true},
	) or_return
	return Game_Map_Tile_Registry_Error.No_Error
}
